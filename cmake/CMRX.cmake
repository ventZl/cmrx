...
macro(add_firmware FW_NAME)
	...
	add_custom_command(TARGET ${FW_NAME} POST_BUILD
		COMMAND python ${CMAKE_SOURCE_DIR}/cmrx/ld/genlink.py ${CMAKE_CURRENT_BINARY_DIR}/helloworld.map ${CMAKE_BINARY_DIR}/gen.appl_data.ld ${CMAKE_BINARY_DIR}/gen.appl_bss.ld
