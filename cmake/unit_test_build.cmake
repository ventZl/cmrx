...
if (CMRX_UNIT_TESTS)
    ...
    if (NOT ("${CMAKE_SOURCE_DIR}" STREQUAL "${CMAKE_CURRENT_SOURCE_DIR}"))
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} "-G${CMAKE_GENERATOR}" -D__UNIT_TESTING_BUILD=1 ${UT_BUILD_OPTIONS} ${CMAKE_CURRENT_SOURCE_DIR}
            WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/tests)
        message(DEBUG Execute COMMAND ${CMAKE_COMMAND} "-G${CMAKE_GENERATOR}" -D__UNIT_TESTING_BUILD=1 ${UT_BUILD_OPTIONS} ${CMAKE_CURRENT_SOURCE_DIR}
            WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/tests)
